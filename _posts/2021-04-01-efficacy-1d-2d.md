...
- Even if immunity would vanish after 6 or 8 weeks (this is a pretty big if), it would still be better to vaccinate people 3 and 4 and 5 times as the ramp up in production more than makes up for loss of doses from needing more on each individual.
  - If you have 10 doses in Jan, 20 in Feb, 40 in March, 80 in April,...
  - You could vaccinate 5,10,20,40 people with 2 doses 
  - Or 10, 20, 30, 60 people with one dose (in March you have 40 doses and you use 30 doses for first time vaccinations and 10 doses to give the first 10 from January a second vaccine).
  - Overall, in the first scenario you have 75 vaccinated people versus 120 in the other.


Therefore, I would conclude that people talking about those two risks are mostly just parroting what other people were saying without having spent a few minutes seriously thinking about it as it doesn't hold up to even basic scrutiny. If anyone has counter arguments, feel free to direct me to them, my contact information is available on the main page of this blog.


PS: The same reasoning with slightly different numbers also applies to the Moderna and AZ vaccines. Their papers don't have a plot that is as nice as the one from the Biontech paper, therefore I used that one for this post. 
